...
void sketchTemplate::dd_sketch(flowkey_t flowkey, parameters &params, int elem, int &min_key, int &max_key) {
    total_counter++;
    // TODO:
    //int index = index_hash->compute_hash(flowkey, params.flowkey_flags, 0, params.is_crc_hash, width);
    //// from ddsketch/mapping.py
    //index = ceil(log2(index) * multiplier)
    //if(index < min_key) {

    //}
    //else if(index > max_key) {

    //}
    //else {
    //    ;
    //}
    //sketchArray[index] += elem;
}
